...
export default function SeputarMasjid() {
  return (
    <section className="w-full min-h-max bg-[url('/vector.svg')] bg-no-repeat bg-[length:578px_443px] bg-right-top max-md:h-min">
      {/* Content Section */}
      <div className="flex justify-center px-32 py-44 items-center max-md:flex-col max-md:text-center max-md:px-10 max-md:py-16 max-xl:gap-32 max-lg:gap-16 max-md:gap-10">
        {/* Img Section */}
