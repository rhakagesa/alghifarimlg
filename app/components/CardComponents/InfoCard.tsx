...
export default function InfoCard({ img, title, description }: InfoCardProps) {
  return (
    <div className="min-w-fit min-h-min border-2 border-[#21536F] rounded-xl p-5 flex gap-6 hover:shadow-xl hover:shadow-slate-400 transition-all duration-300 ease-in-out max-md:flex max-md:flex-col max-md:items-center">
      <img
        src={img}
        alt="gambar"
        className="w-[200px] max-xl:w-[150px] max-lg:w-[100px] max-md:w-fit"
      />
